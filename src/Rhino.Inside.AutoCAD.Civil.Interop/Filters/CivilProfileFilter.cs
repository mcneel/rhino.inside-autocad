...
/// <summary>
/// A filter that selects Civil 3D Profile entities.
/// </summary>
public class CivilProfileFilter : IObjectFilter
{
    /// <inheritdoc />
    public IAutocadSelectionFilterWrapper GetSelectionFilter()
    {
        ...
        {
            new TypedValue((int)DxfCode.Start, RXClass.GetClass(typeof(Profile)).DxfName)
        };
