...
/// <summary>
/// A filter that selects Civil 3D Assembly entities.
/// </summary>
public class CivilAssemblyFilter : IObjectFilter
{
    /// <inheritdoc />
    public IAutocadSelectionFilterWrapper GetSelectionFilter()
    {
        ...
        {
            new TypedValue((int)DxfCode.Start, RXClass.GetClass(typeof(Assembly)).DxfName)
        };
