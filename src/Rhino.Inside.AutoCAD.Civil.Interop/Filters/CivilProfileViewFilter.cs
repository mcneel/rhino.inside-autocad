...
/// <summary>
/// A filter that selects Civil 3D ProfileView entities.
/// </summary>
public class CivilProfileViewFilter : IObjectFilter
{
    /// <inheritdoc />
    public IAutocadSelectionFilterWrapper GetSelectionFilter()
    {
        ...
        {
            new TypedValue((int)DxfCode.Start, RXClass.GetClass(typeof(ProfileView)).DxfName)
        };
