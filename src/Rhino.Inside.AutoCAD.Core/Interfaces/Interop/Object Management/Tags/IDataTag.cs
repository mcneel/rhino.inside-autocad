...
/// <see cref="IDataTag"/> in a <see cref="IDataTagRecord"/>, however it is best
...
/// <see cref="IDataTagRecord.GetFirstValueAt{T}"/>. Collections are one exception
...
/// </summary>
/// <remarks>
/// A <see cref="IDataTag"/> is the equivalent to an AutoCAD TypedValue stored within
...
public interface IDataTag
{
    ...
    /// purposes when stored in a <see cref="IDataTagRecord"/>. See a table
    ...
    /// <summary>
    /// The value of this <see cref="IDataTag"/>. The value must be a single
    /// object and cannot be a collection type. If this <see cref="IDataTag"/>
