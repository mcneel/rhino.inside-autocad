...
/// the code base as they can provide bulk conversion using a single autocad transaction,
/// rather than converting objects one at a time with their own transaction. Each
/// <see cref="IRhinoConvertible"/> wraps a single Rhino Geometry object, but can be
/// converted to multiple <see cref="IEntity"/> objects in AutoCAD.
/// </summary>
