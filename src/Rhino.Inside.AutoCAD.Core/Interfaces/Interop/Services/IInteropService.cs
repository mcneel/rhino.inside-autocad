...
{
    /// <summary>
    /// Event raised when the <see cref="IDocument"/> begins closing , or when the
    ...
    /// <summary>
    /// The <see cref="IDocument"/> instance.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// The <see cref="ITransientManager"/>.
    /// </summary>
    ITransientManager? TransientManager { get; }
}