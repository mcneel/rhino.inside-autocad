...
/// </summary>
public abstract class RhinoInsideAutocad_Component : GH_Component
{
    ...
    /// <summary>
    /// Constructs a new instance of the <see cref="RhinoInsideAutocad_Component"/> class.
    /// </summary>
    protected RhinoInsideAutocad_Component(
        string name,
        string nickname,
        string description,
        string category,
