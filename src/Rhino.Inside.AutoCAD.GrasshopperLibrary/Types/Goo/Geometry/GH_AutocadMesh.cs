...
/// </summary>
public class GH_AutocadMesh : GH_GeometricGoo<AutocadMesh>, IGH_PreviewData, IGH_AutocadReference
{
    ...
    public GH_AutocadMesh(AutocadMesh mesh) : base(mesh.Clone() as AutocadMesh)
    {
    }
    ...
    public GH_AutocadMesh(GH_AutocadMesh other)
    {
        ...
        if (m_value != null)
            m_value = m_value.Clone() as AutocadMesh;
    }

    /// <inheritdoc />
    public override IGH_Goo Duplicate() => (IGH_Goo)this.DuplicateMesh();

    /// <inheritdoc />
    public override IGH_GeometricGoo DuplicateGeometry()
    {
        return (IGH_GeometricGoo)this.DuplicateMesh();
    }

    /// <summary>
    /// Duplicates this <see cref="GH_AutocadMesh"/> instance.
    /// </summary>
    /// <returns></returns>
    public GH_AutocadMesh DuplicateMesh() => new GH_AutocadMesh(this);
